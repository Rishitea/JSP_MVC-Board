...
<section>
<b>글수정</b>
	<form method="post" name="writeForm" action="${pageContext.request.contextPath}/boardtwo/updatePro.do?pageNum=${pageNum}"
	onsubmit="return writeSave()">
		...
		<tr>
			<td colspan="2" class="attr">
				...
				<input type="button" value="목록보기" onClick="window.location='${pageContext.request.contextPath}/boardtwo/list.do?pageNum=${pageNum}'">
			</td>
		</tr>
		</table>
	</form>
