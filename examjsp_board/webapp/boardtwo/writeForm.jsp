...
<b>글쓰기</b>
<br><br>
<form method="post" name="writeForm" action="${pageContext.request.contextPath}/boardtwo/writePro.do" onsubmit="return writeSave()" enctype="multipart/form-data">
	...
	<table class="board">
		...
		<tr>
			<td colspan="2" class="attr">
				...
				<input type="button" value="목록" onClick="window.location='${pageContext.request.contextPath}/boardtwo/list.do'">
			</td>
		</tr>	
	</table>
</form>
